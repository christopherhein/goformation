...
func (r *ScalingPlan_PredefinedScalingMetricSpecification) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *ScalingPlan_PredefinedScalingMetricSpecification) SetResourceCondition(condition string) {
...
func (r *ScalingPlan_PredefinedScalingMetricSpecification) CoreMetadata() map[string]interface{} {
	return r._metadata
}

// SetCoreMetadata enables you to associate structured data with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *ScalingPlan_PredefinedScalingMetricSpecification) SetCoreMetadata(metadata map[string]interface{}) {
