...
func (r *VirtualNode_AwsCloudMapServiceDiscovery) ResourceCondition() string {
	return r._resourceCondition
}

// SetCondition specifies the logical ID of the condition that must be satisfied for this resource to be created
func (r *VirtualNode_AwsCloudMapServiceDiscovery) SetResourceCondition(condition string) {
...
func (r *VirtualNode_AwsCloudMapServiceDiscovery) DependsOn() []string {
	return r._dependsOn
}
...
func (r *VirtualNode_AwsCloudMapServiceDiscovery) CoreMetadata() map[string]interface{} {
	return r._metadata
}

// SetCoreMetadata enables you to associate structured data with this resource.
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-metadata.html
func (r *VirtualNode_AwsCloudMapServiceDiscovery) SetCoreMetadata(metadata map[string]interface{}) {
	r._metadata = metadata
}

// DeletionPolicy returns the AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *VirtualNode_AwsCloudMapServiceDiscovery) DeletionPolicy() policies.DeletionPolicy {
	return r._deletionPolicy
}

// SetDeletionPolicy applies an AWS CloudFormation DeletionPolicy to this resource
// see: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html
func (r *VirtualNode_AwsCloudMapServiceDiscovery) SetDeletionPolicy(policy policies.DeletionPolicy) {
