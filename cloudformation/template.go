...
// JSONWithOption converts AWS CloudFormation template object to json with options
...
// YAML converts an AWS CloudFormation template object to YAML with options
